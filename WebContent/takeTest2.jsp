...
<body>
  ...
  UserDTO userDTO = (UserDTO)session.getAttribute("userdata");
    ...
    String qstn = testDTO.getQuestions().get(1).getQstn();
	String[] options = (String[])testDTO.getQuestions().get(1).getOptions().getArray();
	String answer = testDTO.getQuestions().get(1).getAnswer();
%>
