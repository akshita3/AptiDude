...
<body>
  ...
  UserDTO userDTO = (UserDTO)session.getAttribute("userdata");
    ...
    String qstn = testDTO.getQuestions().get(4).getQstn();
	String[] options = (String[])testDTO.getQuestions().get(4).getOptions().getArray();
	String answer = testDTO.getQuestions().get(4).getAnswer();
%>
