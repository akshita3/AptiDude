...
<body>
  ...
  UserDTO userDTO = (UserDTO)session.getAttribute("userdata");
    ...
    String qstn = testDTO.getQuestions().get(3).getQstn();
	String[] options = (String[])testDTO.getQuestions().get(3).getOptions().getArray();
	String answer = testDTO.getQuestions().get(3).getAnswer();
%>
